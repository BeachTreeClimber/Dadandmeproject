  ...
  <div class="min-h-screen bg-gradient-to-br from-[#d9d4c4] via-[#c7c1ac] to-[#b8b19a] flex items-center justify-center p-4">
    <div class="bg-white/95 rounded-2xl shadow-2xl p-8 sm:p-12 w-full max-w-md border-[6px] border-[#c9c2ab]">
      <div class="text-center mb-8">
        <h1 class="text-4xl font-bold text-[#1f5fbf]" style="font-family: 'Kalam', cursive;">{{ APP_NAME }}</h1>
        <p class="text-slate-500 mt-2">Sign in to get started</p>
      </div>
      <div class="space-y-3">
        <button @click="signInWithGitHub"
          class="w-full flex items-center justify-center gap-3 px-4 py-3 border border-slate-300 rounded-lg text-slate-700 font-medium hover:bg-slate-50 transition-colors">
